...
import com.varconn.inc.campusdotcom.adapters.RelatedAdapter;
...
import com.varconn.inc.campusdotcom.data.sqlite.BookmarkDbController;
import com.varconn.inc.campusdotcom.listeners.ListItemClickListener;
import com.varconn.inc.campusdotcom.listeners.WebListener;
import com.varconn.inc.campusdotcom.models.bookmark.BookmarkModel;
...
import com.varconn.inc.campusdotcom.utility.ActivityUtilities;
import com.varconn.inc.campusdotcom.utility.AdsUtilities;
import com.varconn.inc.campusdotcom.utility.AppUtilities;
import com.varconn.inc.campusdotcom.utility.TtsEngine;
import com.varconn.inc.campusdotcom.webengine.PostWebEngine;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menus_share_post:
                if (mModel != null) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, Html.fromHtml(mModel.getTitle().getRendered())
                            + AppConstant.EMPTY_STRING
                            + mActivity.getResources().getString(R.string.share_text1)
